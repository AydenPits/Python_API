#
# Program Name: Book Database API
#
...
# 11/30/2022
#
# Description: Program that stores books by their id, title, author, and publisher in a database and 
# displays it in a browser page. The program also allows books to be added or removed from the database.
#
